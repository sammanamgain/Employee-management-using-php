        ...
        <?php foreach ($companydetails as $company) { ?>
            <div class="col mb-4">
                <div class="card h-100" style="width: 18rem;">
                    <img src="" class="card-img-top" alt="Company Image" height=50%>
                    <div class="card-body d-flex flex-column">
                        <h5 class="card-title"><?php echo $company['Name']; ?></h5>
                        <p class="card-text"><?php echo $company['Salary']; ?></p>
                        <p class="card-text"><?php echo $company['BirthDate']; ?></p>
                        <p class="card-text"><?php echo $company['Company']; ?></p>
                        <a href="update1.php?id=<?php echo $company['id'];?>" class="btn btn-primary mt-auto" >UPDATE</a>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            // You can update the UI or reload data here if necessary
             window.location.replace('testing1.php');
        },
